/*
  # Fix RLS Policies with Proper Cleanup and Add Promotion Type Constraint
  
  1. Changes
    - Drop all existing policies first
    - Recreate policies with proper checks
    - Use UUID for admin identification
    - Add proper constraint for promotion types
...
ALTER TABLE promotions DROP CONSTRAINT IF EXISTS valid_promotion_type;
ALTER TABLE promotions ADD CONSTRAINT valid_promotion_type 
  CHECK (type IN ('percentage', 'fixed', '2x1', '3x2', '3x1'));
